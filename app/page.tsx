        ...
        <div className="container-page">
          <div className="mb-8 flex items-end justify-between gap-4">
            <div>
              ...
              <p className="section-copy mt-3">Four focused cohorts built to give students practical skills and visible outcomes.</p>
            </div>
        ...
        <div className="glass-panel grid gap-8 rounded-3xl p-8 md:grid-cols-[1.2fr_0.8fr] md:items-center">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-base leading-7 text-slate-600 dark:text-slate-300">
              Explore the programs page to see what is open now and how each cohort is structured.
            </p>
          </div>
